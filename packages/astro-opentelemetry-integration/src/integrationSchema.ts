...
export const integrationSchema = z
	.object({
		...
		otel: z
			...
			.default({ serviceName: "unknown_service", serviceVersion: "unknown_version" }),
		presets: z
			.object({
				metricExporter: z
	...
	.default({ enabled: true, otel: { serviceName: "unknown_service", serviceVersion: "unknown_version" } });
