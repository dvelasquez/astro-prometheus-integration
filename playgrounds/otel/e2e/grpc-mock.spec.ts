...
// Test suite for Astro OpenTelemetry gRPC Integration (Mock-based)
test.describe("Astro OpenTelemetry gRPC Integration (Mock Tests)", () => {
	...
	test.describe("gRPC Export Configuration", () => {
		test("should have gRPC export configured", async ({ page }) => {
