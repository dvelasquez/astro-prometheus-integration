...
export class MetricsHelper {
	...
	async waitForMetricValue(
		...
		throw new Error(
			`Metric ${metricName} did not reach value ${expectedValue} within ${timeout}ms`,
		);
	}
 ...
 */
export function createMetricsHelper(
	page: Page,
	baseURL?: string,
	metricsURL?: string,
): MetricsHelper {
